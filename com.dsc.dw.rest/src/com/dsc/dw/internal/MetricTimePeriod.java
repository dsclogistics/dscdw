	...
	public Response MetricTimePeriod(JSONObject inputJsonObj) throws JSONException {
        ...
        catch(Exception e)
        {
		 ...
		 try {
   		  ...
   		  String SQL = "  select mtp.tm_period_id,mtpt.tpt_id from   [DSC_MTRC_DEV].[dbo].[MTRC_TIME_PERIOD_TYPE] mtpt "+
                       " join [DSC_MTRC_DEV].[dbo].[MTRC_TM_PERIODS] mtp on mtp.tpt_id = mtpt.tpt_id "+
